                                    ...
                                    <div className="row align-items-center">
                                        <div className="col-xl-6">
                                            <div className="card-bx bg-blue">
                                                <img className="pattern-img" src="public/assets/images/pattern/pattern6.png" alt="" />
                                                <div className="card-info text-white">
                                                    <img src="public/assets/images/pattern/circle.png" className="mb-4" alt="" />
                                                    <h2 className="text-white card-balance">$824,571.93</h2>
                                                    <p className="fs-16">Wallet Balance</p>
                                                    <span>+0,8% than last week</span>
                                                </div>
                                                <a className="change-btn" href="javascript:void(0);"><i className="fa fa-caret-up up-ico"></i>Change<span className="reload-icon"><i className="fas fa-sync-alt reload active"></i></span></a>
                                            </div>
                                        </div>
                                        <div className="col-xl-6">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="user-bx">
                                        <img src="public/assets/images/profile/small/pic1.jpg" alt="" />
                                        <div>
                                    ...
                                    <h4 className="mt-3 mb-3">Recent Friend<a href="javascript:void(0);" className="fs-16 float-end text-secondary font-w600">See More</a></h4>
                                    <ul className="user-list">
                                        <li><img src="public/assets/images/avatar/1.jpg" alt="" /></li>
                                        <li><img src="public/assets/images/avatar/2.jpg" alt="" /></li>
                                        <li><img src="public/assets/images/avatar/3.jpg" alt="" /></li>
                                        <li><img src="public/assets/images/avatar/4.jpg" alt="" /></li>
                                        <li><img src="public/assets/images/avatar/5.jpg" alt="" /></li>
                                        <li><img src="public/assets/images/avatar/6.jpg" alt="" /></li>
                                    </ul>
                                ...
                                <div className="card-footer border-0 pt-0">
                                    <a href="javascript:void(0);" className="btn btn-primary d-block btn-lg text-uppercase">Transfer Now</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-3 col-xxl-5">
                                            ...
                                            <table className="table table-responsive-md card-table transactions-table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span className="text-warning fs-16 font-w500 text-end d-block">Pending</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <svg className="bgl-success tr-icon" width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
